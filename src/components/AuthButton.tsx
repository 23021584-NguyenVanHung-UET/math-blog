...
export default function AuthButton() {
  ...
  if (loading) {
    return <div className="h-8 w-8 animate-pulse rounded-full bg-[var(--bg-secondary)]" />;
  }
    ...
    <div className="relative">
      ...
      {menuOpen && (
        <>
          ...
          <div className="absolute right-0 top-10 z-50 min-w-48 rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-1 shadow-lg">
            <div className="px-3 py-2 text-sm">
              <p className="font-medium text-[var(--text)]">{user.displayName}</p>
